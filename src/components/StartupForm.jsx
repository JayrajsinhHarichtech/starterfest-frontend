...
const StartupForm = ({ values, handleChange, handleFileChange, formErrors, isSubmit, handleSubmit, country, states, fetchState, setValues, isdCodes, categories, stages }) => {
    return (
        <div>
            ...
            <div>
                <Button type="button" color="primary" className="mt-3 register-btn" onClick={handleSubmit}>Register</Button>
            </div>
        </div>

...
const QuoteSection = ({ image, quote, author }) => {
  return (
    <section className="relative w-full min-h-[70vh] overflow-hidden bg-gray-900">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-[70vh] px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-6 md:p-10 border border-white/20">
            ...
            <cite className="text-base md:text-lg text-[#f8a405] font-semibold">
              — {author}
            </cite>
          </div>
        </div>
      ...
      {/* Decorative Elements */}
      <div className="absolute top-10 left-10 w-20 h-20 border-l-4 border-t-4 border-[#f8a405] opacity-30"></div>
      <div className="absolute bottom-10 right-10 w-20 h-20 border-r-4 border-b-4 border-[#f8a405] opacity-30"></div>
    </section>
  );
};
